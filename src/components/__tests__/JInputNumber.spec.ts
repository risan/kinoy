...
describe('JInputNumber', () => {
  ...
  describe('v-model', () => {
    it('displays formatted value when modelValue is set', async () => {
      const wrapper = mount(JInputNumber, {
  ...
  describe('vee-validate integration', () => {
    ...
    it('displays validation error after field is touched and invalid', async () => {
      const wrapper = mountWithForm(JInputNumber, schema, 'amount', {}, null);
      await flushCurrencyInput();
    ...
    it('emits update:modelValue in vee-validate mode', async () => {
      ...
      const baseInputNumber = wrapper.findComponent(JInputNumber);
  ...
  describe('accessibility', () => {
    ...
    it('generates unique IDs', () => {
      const Wrapper = defineComponent({
        components: { JInputNumber },
        template: `<div>
          <JInputNumber :model-value="null" />
          <JInputNumber :model-value="null" />
        </div>`,
      });
