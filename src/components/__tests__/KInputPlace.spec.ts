...
import KInputPlace from '../KInputPlace.vue';
...
describe('KInputPlace', () => {
  ...
  describe('props passthrough', () => {
    it('passes label prop to KInputAutocomplete', async () => {
      const mockPlaces = createMockPlaces();
      mockImportLibrary.mockResolvedValue(mockPlaces);
    ...
    it('passes error prop to KInputAutocomplete', async () => {
      const mockPlaces = createMockPlaces();
      mockImportLibrary.mockResolvedValue(mockPlaces);
    ...
    it('passes attrs to KInputAutocomplete', async () => {
      const mockPlaces = createMockPlaces();
      mockImportLibrary.mockResolvedValue(mockPlaces);
