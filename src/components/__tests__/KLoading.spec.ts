...
describe('KLoading', () => {
  ...
  describe('size prop', () => {
    ...
    it('applies xs size (h-3 w-3)', () => {
      const wrapper = mount(KLoading, { props: { size: 'xs' } });
      const svg = wrapper.find('svg');
    ...
    it('applies sm size (h-4 w-4)', () => {
      const wrapper = mount(KLoading, { props: { size: 'sm' } });
      const svg = wrapper.find('svg');
    ...
    it('applies lg size (h-8 w-8)', () => {
      const wrapper = mount(KLoading, { props: { size: 'lg' } });
      const svg = wrapper.find('svg');
  ...
  describe('color prop', () => {
    ...
    it('applies text-primary for primary color', () => {
      const wrapper = mount(KLoading, { props: { color: 'primary' } });
      expect(wrapper.classes()).toContain('text-primary');
    });

    it('applies text-input-placeholder for muted color', () => {
      const wrapper = mount(KLoading, { props: { color: 'muted' } });
  ...
  describe('accessibility', () => {
    ...
    it('uses custom label prop for aria-label', () => {
      const wrapper = mount(KLoading, { props: { label: 'Loading options' } });
    ...
    it('sr-only text matches label prop', () => {
      const wrapper = mount(KLoading, { props: { label: 'Please wait' } });
  ...
  describe('overlay mode', () => {
    it('renders as a <div> with overlay classes', () => {
      const wrapper = mount(KLoading, { props: { overlay: true } });
