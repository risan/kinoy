...
import JInputCurrency from '../JInputCurrency.vue';
import {
  flushValidation,
  flushCurrencyInput,
...
describe('JInputCurrency', () => {
  ...
  describe('currency formatting', () => {
    it('displays value with currency symbol', async () => {
      const wrapper = mount(JInputCurrency, {
  ...
  describe('vee-validate', () => {
    it('works with useForm and yup number validation', async () => {
      ...
      const wrapper = mountWithForm(JInputCurrency, schema, 'price', {}, null);
      await flushCurrencyInput();
      const input = wrapper.find('input');
