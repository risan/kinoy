...
describe('KInputAutocomplete', () => {
  ...
  describe('v-model', () => {
    it('displays the modelValue as input value', () => {
      const wrapper = mount(KInputAutocomplete, {
  ...
  describe('vee-validate integration', () => {
    ...
    it('displays validation error after blur', async () => {
      const wrapper = mountWithForm(KInputAutocomplete, schema, 'address', {
        search: createSearch(),
      });
      const input = wrapper.find('input');
  ...
  describe('error states', () => {
    ...
    it('manual error takes priority over vee-validate error', async () => {
      ...
      const wrapper = mountWithForm(KInputAutocomplete, schema, 'field', {
        search: createSearch(),
        error: 'Manual error',
      });
      const input = wrapper.find('input');
