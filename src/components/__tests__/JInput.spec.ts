...
describe('JInput', () => {
  ...
  describe('vee-validate integration', () => {
    ...
    it('displays validation error after field is touched and invalid', async () => {
      const wrapper = mountWithForm(JInput, schema, 'email');
    ...
    it('emits update:modelValue even in vee-validate mode', async () => {
      ...
      // The event is emitted on the JInput component (child of wrapper)
      const baseInput = wrapper.findComponent(JInput);
  ...
  describe('error states', () => {
    ...
    it('manual error takes priority over vee-validate error', async () => {
      ...
      const wrapper = mountWithForm(JInput, schema, 'name', {
        error: 'Manual error',
      });
      const input = wrapper.find('input');
  ...
  describe('accessibility', () => {
    ...
    it('generates a unique id when id prop is not provided', () => {
      const Wrapper = defineComponent({
        components: { JInput },
        template: '<div><JInput model-value="" /><JInput model-value="" /></div>',
      });
